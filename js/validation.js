...
const typeSelector = uploadForm.querySelector('#type');
const priceField = uploadForm.querySelector('#price');
...
const selectCapacity = uploadForm.querySelector('#capacity');
const selectRooms = uploadForm.querySelector('#room_number');
